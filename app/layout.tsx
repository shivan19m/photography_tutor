          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <div className="flex items-center space-x-6">
                <a 
                  href="/learn" 
                  className="relative text-gray-600 hover:text-gray-900 transition-colors px-3 py-2 rounded-lg hover:bg-gray-100/50 group"
                >
                  <span className="relative z-10">Learn</span>
                  <div className="absolute inset-0 bg-blue-100 rounded-lg opacity-0 transform scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all" />
                </a>
                <a 
                  href="/quiz" 
