  ...
  return (
    <div className="max-w-6xl mx-auto p-8 space-y-8">
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-white">Photo Playground</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="space-y-4">
          {selectedImage ? (
            ...
            <div
              className="min-h-[300px] rounded-xl border-2 border-dashed border-white/30 flex items-center justify-center cursor-pointer hover:border-white/50 transition-colors"
              onClick={() => fileInputRef.current?.click()}
              onDragOver={handleDragOver}
              onDrop={handleDrop}
            >
              <div className="text-center space-y-2 p-8">
                <div className="w-12 h-12 mx-auto text-white/80">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                  </svg>
                </div>
                <div>
                  <p className="text-white/80">Drag & drop an image here or click to browse</p>
                  <p className="text-sm text-white/60 mt-1">Supports JPG, PNG files</p>
                </div>
              </div>
              <input
                type="file"
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 space-y-6">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold min-w-[40px] text-center">{formatISO(settings.iso)}</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-semibold min-w-[40px] text-center">{formatAperture(settings.aperture)}</span>
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold min-w-[40px] text-center">{formatShutterSpeed(settings.shutterSpeed)}</span>
              </div>
            </div>
          </div>

          {!selectedImage && (
            <div className="bg-white/10 rounded-xl p-6 text-white/80 text-center">
